...
#if 1 // SYNERGYS : VIN PIN MUX
 	TI816X_MUX(TSO1_DATA, OMAP_MUX_MODE2),      //VIN[1]A_D[0]
 	TI816X_MUX(TSO1_BYTSTRT, OMAP_MUX_MODE2),   //VIN[1]A_D[1]
 	TI816X_MUX(TSO1_PACVAL, OMAP_MUX_MODE2),    //VIN[1]A_D[2]
 	TI816X_MUX(TSO1_PACERR, OMAP_MUX_MODE2),    //VIN[1]A_D[3]
 	TI816X_MUX(TSI3_DCLK, OMAP_MUX_MODE2),      //VIN[1]A_D[4]
 	TI816X_MUX(TSI3_DATA, OMAP_MUX_MODE2),      //VIN[1]A_D[5]
 	TI816X_MUX(TSI3_BYTSTRT, OMAP_MUX_MODE2),   //VIN[1]A_D[6]
 	TI816X_MUX(TSI3_PACVAL, OMAP_MUX_MODE2),    //VIN[1]A_D[7]
 	TI816X_MUX(TSI3_PACERR, OMAP_MUX_MODE2),    //VIN[1]A_D[8]
	TI816X_MUX(TSI1_DCLK, OMAP_MUX_MODE2),      //VIN[1]A_D[9]
 	TI816X_MUX(TSI1_DATA, OMAP_MUX_MODE2),      //VIN[1]A_D[10]
 	TI816X_MUX(TSI1_BYTSTRT, OMAP_MUX_MODE2),   //VIN[1]A_D[11]
 	TI816X_MUX(TSI1_PACVAL, OMAP_MUX_MODE2),    //VIN[1]A_D[12]
 	TI816X_MUX(TSI1_PACERR, OMAP_MUX_MODE2),    //VIN[1]A_D[13]
 	TI816X_MUX(TSI2_DCLK, OMAP_MUX_MODE1),      //VIN[1]A_D[14]
 	TI816X_MUX(TSI4_DCLK, OMAP_MUX_MODE2),      //VIN[1]A_D[15] 
 	TI816X_MUX(TSO1_DCLK, OMAP_MUX_MODE2),      //VIN[1]A_CLK
