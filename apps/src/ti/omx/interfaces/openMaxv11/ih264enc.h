...
/**
  ...
  *                         [Santoshkumar S K]
  * @version  1.5 May 2012: SDOCM00091641 : Adding temporalId parameter to 
...
typedef enum
{
  ...
  IH264_SCALINGMATRIX_DEFAULT     = IH264_SCALINGMATRIX_NONE, 
...
typedef struct IH264ENC_DynamicParams {
  ...
  XDM_Point                    searchCenter        ;
  XDAS_Int8                    enableStaticMBCount ;
  XDAS_Int32                   intraRefreshRateGDRDynamic;
  XDAS_Int32                   gdrOverlapRowsBtwFramesDynamic;
  XDAS_Int32                   enableROI;
  XDAS_Int32                   reservedDynParams[1];
